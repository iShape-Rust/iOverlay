...
pub(crate) struct ShapeCountString {
    pub(crate) subj: i32,
    pub(crate) bold: bool,
}
...
impl OverlayGraph<'_> {
    #[inline]
    pub(crate) fn offset_graph_with_solver(mut segments: Vec<Segment<ShapeCountString>>, split_solver: &mut SplitSolver, solver: Solver) -> Option<OverlayGraph> {
        ...
        let fills = GraphBuilder::fill::<SubjectOffsetStrategy, ShapeCountString>(is_list, &segments);
