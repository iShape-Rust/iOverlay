...
//
// pub(super) struct ExpandBevelJoinBuilder;
//
// impl ExpandBevelJoinBuilder {
//     #[inline]
...
//         }
//
//         segments.push(Segment::subject(b0, a1));
//     }
// }
//
// impl<T: FloatNumber, P: FloatPointCompatible<T>> JoinBuilder<P, T> for ExpandBevelJoinBuilder {
//     #[inline]
//     fn add_join(
//         &self,
//         s0: &Section<P, T>,
...
// }
//
// pub(super) struct ExpandMiterJoinBuilder<T> {
//     limit_dot_product: T,
//     expand: bool,
//     max_offset: T,
//     max_length: T,
// }
//
// impl<T: FloatNumber> ExpandMiterJoinBuilder<T> {
...
// }
//
// impl<T: FloatNumber, P: FloatPointCompatible<T>> JoinBuilder<P, T> for ExpandMiterJoinBuilder<T> {
//     fn add_join(
//         &self,
//         s0: &Section<P, T>,
//         s1: &Section<P, T>,
...
//         segments: &mut Vec<Segment<ShapeCountBoolean>>,
//     ) {
//         let turn = s0.is_positive_turn(s1);
//         if turn == self.expand {
//             ExpandBevelJoinBuilder::join(s0, s1, adapter, segments);
//             return;
//         }
//
//         let pa = s0.b_top;
...
//                 SharpMiter::AB(a, b) => segments.push(Segment::subject(a, b)),
//                 SharpMiter::AcB(a, c, b) => {
//                     segments.push(Segment::subject(a, c));
//                     segments.push(Segment::subject(c, b));
//                 }
...
// }
//
// pub(super) struct ExpandRoundJoinBuilder<T> {
//     inv_ratio: T,
//     average_count: usize,
//     radius: T,
//     limit_dot_product: T,
...
// }
//
// impl<T: FloatNumber> ExpandRoundJoinBuilder<T> {
...
//     }
// }
// impl<T: FloatNumber, P: FloatPointCompatible<T>> JoinBuilder<P, T> for ExpandRoundJoinBuilder<T> {
//     fn add_join(
//         &self,
//         s0: &Section<P, T>,
//         s1: &Section<P, T>,
