...
pub struct Solver {
    ...
    pub pre_split_enabled: bool,
    pub pre_split_max_iterations: usize,
    pub pre_split_multithread_threshold: usize,
    pub pre_split_skip_threshold: usize,
}

impl Solver {
    // Predefined solver configurations for different strategies.
    pub const LIST: Self = Self {
        strategy: List,
        chunk_start_length: 8,
        chunk_list_max_size: 256,
        pre_split_enabled: true,
        pre_split_max_iterations: 3,
        pre_split_multithread_threshold: 1 << 16,
        pre_split_skip_threshold: 1 << 22,
    };
    ...
    // Constructor to create a new Solver with a specified strategy.
