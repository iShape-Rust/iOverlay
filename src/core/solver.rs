...
pub struct Solver {
    ...
    pub pre_split_max_count: usize
}

impl Solver {
    pub const LIST: Self = Self { strategy: List, chunk_start_length: 8, chunk_list_max_size: 256, pre_split_max_count: 3 };
    pub const TREE: Self = Self { strategy: Tree, chunk_start_length: 8, chunk_list_max_size: 256, pre_split_max_count: 3 };
    pub const AUTO: Self = Self { strategy: Auto, chunk_start_length: 8, chunk_list_max_size: 256, pre_split_max_count: 3 };

    pub fn new(strategy: Strategy) -> Self {
        Self { strategy, chunk_start_length: 8, chunk_list_max_size: 256, pre_split_max_count: 3 }
    }
}